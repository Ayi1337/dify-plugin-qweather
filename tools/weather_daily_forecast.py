...
ALLOWED_DAYS = {"3d", "7d", "10d", "15d", "30d"}
WEATHER_DAILY_PATH_TEMPLATE = "/v7/weather/{days}"


class QWeatherWeatherDailyForecastTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        path = WEATHER_DAILY_PATH_TEMPLATE.format(days=days)
        ...
        if code and code not in ("200", "204"):
            raise RuntimeError(f"QWeather Daily Forecast API error: code={code}, response={data}")
