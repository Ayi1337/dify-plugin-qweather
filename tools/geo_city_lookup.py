...
CITY_LOOKUP_SUFFIX = "/city/lookup"


class QWeatherGeoCityLookupTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        path = geo_v2_path(base_url, CITY_LOOKUP_SUFFIX)
        ...
        if code and code not in ("200", "204"):
            raise RuntimeError(f"QWeather Geo City Lookup API error: code={code}, response={data}")
