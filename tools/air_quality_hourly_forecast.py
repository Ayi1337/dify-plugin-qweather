...
AIR_QUALITY_HOURLY_PATH_TEMPLATE = "/airquality/v1/hourly/{latitude}/{longitude}"


class QWeatherAirQualityHourlyForecastTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        path = AIR_QUALITY_HOURLY_PATH_TEMPLATE.format(latitude=latitude, longitude=longitude)
        ...
        if code and code not in ("200", "204"):
            raise RuntimeError(f"QWeather Air Quality Hourly Forecast API error: code={code}, response={data}")
